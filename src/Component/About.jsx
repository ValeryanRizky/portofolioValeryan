...
export default function About() {
    return (
        <section
            id="about"
            className="relative bg-slate-50 text-slate-900 py-20 sm:py-24 px-4 sm:px-6 overflow-hidden"
        >
            ...
            >
                <motion.div variants={itemVariants} className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed text-sm sm:text-base px-2">
                ...
                <div className="grid md:grid-cols-2 gap-10 md:gap-10">
                    ...
                    <motion.div variants={itemVariants}>
                        <div className="flex items-center gap-3 mb-5 sm:mb-6">
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold text-slate-900">Pendidikan</h3>
                        </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            {education.map((edu, i) => (
                                <motion.div
                                    ...
                                    className="group bg-white rounded-2xl p-3.5 sm:p-5 border border-slate-200 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-100/50 transition-colors flex items-center gap-3 sm:gap-5"
                                >
                                    <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center shrink-0 overflow-hidden group-hover:scale-105 transition-transform">
                                        <img
                                            src={edu.logo}
                                            alt={`Logo ${edu.name}`}
                                            ...
                                            onError={(e) => {
                                                ...
                                                e.target.parentElement.innerHTML = '<span class="text-[10px] sm:text-sm font-bold text-slate-400">LOGO</span>'
                                            }}
                                        />
                                    </div>
                    ...
                    <motion.div variants={itemVariants}>
                        <div className="flex items-center gap-3 mb-5 sm:mb-6">
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold text-slate-900">Pengalaman</h3>
                        </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            {experience.map((exp) => (
                                <motion.div
                                    ...
                                    whileHover={{ y: -4, scale: 1.01 }}
                                    transition={{ type: 'spring', stiffness: 300, damping: 20 }}
                                    className={`group bg-white rounded-2xl p-3.5 sm:p-5 border border-slate-200 flex items-center gap-3 sm:gap-5 transition-colors hover:shadow-lg ${exp.color === 'blue'
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className={`text-xs sm:text-sm font-medium mt-0.5 ${exp.color === 'blue' ? 'text-blue-600' : 'text-cyan-600'
                                            }`}>
                                            {exp.role}
                                        </p>
